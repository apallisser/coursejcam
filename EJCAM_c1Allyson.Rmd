...
---
## La technologie derrière les portails open data
...
### .red[Les solutions propriétaires]
...
---
## CKAN vs les solutions "clé en main"

 Aujourd’hui, l'avancée des solutions propriétaires est bien visible, même si le CKAN reste majeur. 
...
### .red[Comparez les 5 grandes fonctions de 5 portails open data pour l’utilisateur des données :] 

**Naviguer, Interagir, Comprendre, Exporter/Telecharger, Prévisualiser.**
